...
def main(opt):
    ...
    if opt.eval_model_path:
        ...
        model_path = os.path.join(folder_path, 'model-best.pth') # best
    ...
    if opt.eval_mode == 'eval_testset':
        opt.gt_file_for_eval = [opt.gt_file_test]
    ...
    #
    # loader = DataLoader(val_dataset, batch_size=opt.batch_size_for_eval,
    #                         shuffle=False, num_workers=opt.nthreads, collate_fn=collate_fn_train)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt_file_test', type=str, default=None)
