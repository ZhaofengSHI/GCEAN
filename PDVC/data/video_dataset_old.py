...
def collate_fn_train(batch):
    ...
    # feats, gt_featstamps, action_labels, caption_label, gt_timestamps, duration, captions, key ,feats_view2, key_view2
    ...
    feature_size_view2 = batch[0][-2].shape[1]
    # print(feature_size_view2)


    feature_list, gt_timestamps_list, labels, caption_list, gt_raw_timestamp, raw_duration, raw_caption, key, feature_list_view2, key_view2 = zip(
        *batch)
    ...
    # video_length_view2 = torch.FloatTensor(batch_size, 3).zero_()  # true length, sequence length
    ...
    # print(video_tensor_view2.shape)
    # print(video_mask_view2)
    # print(list(key_view2))
    # print(video_length)
...
class DVC_DA_Dataset(EDVCdataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.is_training:
            ...
            return feats, gt_featstamps, action_labels, caption_label, gt_timestamps, duration, captions, key, feats_view2, key_view2
