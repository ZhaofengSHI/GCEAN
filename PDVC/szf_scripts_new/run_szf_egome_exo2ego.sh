...
# Training
GPU_ID=$1
EXP_NAME=egome_DA_clip_pdvc_exo2ego_5fps
SAVE_DIR=$2 #'save_egome_exo2ego'
DIS_LOSS_COEF=$3
PRETRAIN=$4
PRETRAIN_PATH=$5
ADV_LOSS_COEF=$6
...
#gt_file_para_test='/data1/zhaofeng/EgoMe_processing/EgoMe_new_jsons/official_split_processed/para_egome_val_exo.json'
#
#eval_folder=${EXP_NAME} # specify the folder to be evaluated
#python eval_szf.py --eval_folder ${eval_folder} \
# --eval_transformer_input_type queries \
