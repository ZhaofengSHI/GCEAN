...
def parse_opts():
    ...
    parser.add_argument("--bank_path",type = str, default = '/data1/zhaofeng/EgoMe_processing/EgoMe_new_jsons/official_split_processed/bank_official')
    ...
    parser.add_argument("--num_attn_heads", type=int, default=8, help="stop if the model is not improving for max_es_cnt max_es_cnt")
    
    parser.add_argument('--dis_loss_coef', default=0.1, type=float)
    parser.add_argument('--adv_loss_coef', default=0.1, type=float)
    parser.add_argument('--adv_loss_margin', default=0.5, type=float)

    parser.add_argument('--gz_pre_loss_coef', default=10.0, type=float)
    parser.add_argument('--gz_view2_pre_loss_coef', default=10.0, type=float)
    parser.add_argument('--gz_dis_loss_coef', default=1.0, type=float)
    parser.add_argument('--gz_adv_loss_coef', default=1.0, type=float)
    parser.add_argument('--multi_scale_dis_loss_coef', default=1.0, type=float)

    parser.add_argument('--kl_loss_0', default=1.0, type=float)
    parser.add_argument('--kl_loss_1', default=1.0, type=float)
    parser.add_argument('--kl_loss_2', default=1.0, type=float)
    parser.add_argument('--kl_loss_3', default=1.0, type=float)
    
    parser.add_argument('--lr_high', type=float, default=1e-4, help='1e-4 for resnet feature and 5e-5 for C3D feature')
    parser.add_argument('--lr_low', type=float, default=1e-4, help='1e-4 for resnet feature and 5e-5 for C3D feature')
