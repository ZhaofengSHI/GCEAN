...
GPU_ID=$1
EXP_NAME=egome_clip_cm2_exo2ego_5fps
SAVE_DIR=$2
DIS_LOSS_COEF=$3
PRETRAIN=$4
PRETRAIN_PATH=$5
...
--target_domain egome_exo --bank_type egome_exo --soft_k 80 --window_size 50 \
...
--text_crossAttn_loc after --target_domain egome_exo --bank_type egome_exo --sim_match window_cos \
