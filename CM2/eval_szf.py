...
from data.video_dataset import DVC_DA_Dataset, collate_fn_train,collate_fn_eval  #, PropSeqDataset,
...
def main(opt):
    ...
    if opt.eval_model_path:
        ...
        model_path = os.path.join(folder_path, 'model-best.pth') #model-best.pth
    ...
    #####
    if opt.eval_mode == 'eval_testset':
        opt.gt_file_for_para_eval = [opt.gt_file_for_para_test]
    #####
    ...
    val_dataset = DVC_DA_Dataset(opt.eval_caption_file,
                                 opt.visual_feature_folder,
                                 opt.dict_file, False, opt.eval_proposal_type,
                                 opt)
    loader = DataLoader(val_dataset, batch_size=opt.batch_size_for_eval,
                        shuffle=False, num_workers=opt.nthreads, collate_fn=collate_fn_eval)
    ...
    if opt.eval_mode == 'test':
        ...
        F_score = 2. / (1. / avg_eval_score['Precision'] + 1. / avg_eval_score['Recall'])
        avg_eval_score.update({'F-score':F_score})
...
if __name__ == '__main__':
    ...
    parser.add_argument('--eval_mode', type=str, default='eval', choices=['eval', 'eval_testset', 'test'])
    ...
    parser.add_argument('--gt_file_for_para_test', type=str, default=None) ###
    ...
    opt.test_video_feature_folder=opt.test_video_feature_folder
    opt.eval_caption_file=opt.eval_caption_file
    opt.eval_gt_file_for_caption = [opt.eval_caption_file]
    ...
    #     opt.target_domain='anet'
    #
    # elif opt.eval_folder=='egome_clip_cm2_exo_2fps':
    #     opt.test_video_feature_folder='data/egome/features/egome_2fps_clipvitl14.pth'
    #     opt.eval_caption_file='/data1/zhaofeng/DenseVideoCaption/EgoMe-DVC/EgoMe-CM2_DVC/data/egome/captiondata/egome_val_exo.json'
    #     opt.eval_gt_file_for_caption=['/data1/zhaofeng/DenseVideoCaption/EgoMe-DVC/EgoMe-CM2_DVC/data/egome/captiondata/egome_val_exo.json']
    #     # opt.target_domain='yc2'
    # elif opt.eval_folder=='egome_clip_cm2_ego_2fps':
    #     opt.test_video_feature_folder='data/egome/features/egome_2fps_clipvitl14.pth'
    #     opt.eval_caption_file='/data1/zhaofeng/DenseVideoCaption/EgoMe-DVC/EgoMe-CM2_DVC/data/egome/captiondata/egome_val_ego.json'
    #     opt.eval_gt_file_for_caption=['/data1/zhaofeng/DenseVideoCaption/EgoMe-DVC/EgoMe-CM2_DVC/data/egome/captiondata/egome_val_ego.json']
    #     # opt.target_domain='yc2'
    #
    # elif opt.eval_folder=='egome_clip_cm2_exo_5fps':
    #     opt.test_video_feature_folder='data/egome/features/egome_5fps_clipvitl14.pth'
    #     opt.eval_caption_file='/data1/zhaofeng/DenseVideoCaption/EgoMe-DVC/EgoMe-CM2_DVC/data/egome/captiondata/egome_val_exo.json'
    #     opt.eval_gt_file_for_caption=['/data1/zhaofeng/DenseVideoCaption/EgoMe-DVC/EgoMe-CM2_DVC/data/egome/captiondata/egome_val_exo.json']
    #     # opt.target_domain='yc2'
    # elif opt.eval_folder=='egome_clip_cm2_ego_5fps':
    #     opt.test_video_feature_folder='data/egome/features/egome_5fps_clipvitl14.pth'
    #     opt.eval_caption_file='/data1/zhaofeng/DenseVideoCaption/EgoMe-DVC/EgoMe-CM2_DVC/data/egome/captiondata/egome_val_ego.json'
    #     opt.eval_gt_file_for_caption=['/data1/zhaofeng/DenseVideoCaption/EgoMe-DVC/EgoMe-CM2_DVC/data/egome/captiondata/egome_val_ego.json']
    #     # opt.target_domain='yc2'
    #
    # elif opt.eval_folder=='egome_clip_cm2_ego2exo_5fps':
    #     opt.test_video_feature_folder='data/egome/features/egome_5fps_clipvitl14.pth'
    #     opt.eval_caption_file='data/egome/captiondata/egome_val_exo.json'
    #     opt.eval_gt_file_for_caption=['data/egome/captiondata/egome_val_exo.json']
    #     # opt.target_domain='yc2'
    # elif opt.eval_folder=='egome_clip_cm2_exo2ego_5fps':
    #     opt.test_video_feature_folder='data/egome/features/egome_5fps_clipvitl14.pth'
    #     opt.eval_caption_file='data/egome/captiondata/egome_val_ego.json'
    #     opt.eval_gt_file_for_caption=['data/egome/captiondata/egome_val_ego.json']
    #     # opt.target_domain='yc2'
    # #####
